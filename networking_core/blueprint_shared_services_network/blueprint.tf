...
locals {
  SHARED-SERVICES-NET-RG = module.shared_services_resource_groups.names.shared_services_network
  SHARED-SERVICES-NET-LOCATION = module.shared_services_resource_groups.object.shared_services_network.location
}
